...
public abstract class AbstractChatListener implements PacketListener {
     ...
     */
    public AbstractChatListener(PresenceCache cache, MultiUserChat chat)
	    throws NullPointerException {
	if (cache == null)
	    throw new NullPointerException("Presence cache can't be null");
	if (chat == null)
	    throw new NullPointerException("Chat can't be null");
