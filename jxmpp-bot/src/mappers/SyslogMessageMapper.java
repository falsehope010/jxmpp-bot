...
public class SyslogMessageMapper extends AbstractMapper {
    ...
    public List<Message> getMessages(String msgText, Date startDate,
	    Date endDate, List<SyslogSession> sessionsList,
	    List<String> typesList, List<String> cathegoriesList,
	...
	if (msg != null && msg.getCategory() != null) {
	    ...
	    MessageCategory persistentCategory = getCategory(msgCategory
		    .getName());
